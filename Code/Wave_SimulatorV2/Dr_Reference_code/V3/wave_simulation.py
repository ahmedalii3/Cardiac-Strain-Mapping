...
from helper import dilate_mask, dilate_mask_fade, dilate_mask_fade_cosine, dilate_mask_fade_smooth
...
def animate_deformed_masked_mri(Image, MaskHT0, FrameDisplX, FrameDisplY, 
                                ...
                                , save_mode= False, json_mode= False):
    """
    ...
    Image_deformed_all_before = np.zeros((height, width, num_frames), dtype=np.float32)
    ...
    def update(frame):
        ...
        Image_deformed_all_before[:, :, int(frame)] = Image
        # Apply remap to warp the image
