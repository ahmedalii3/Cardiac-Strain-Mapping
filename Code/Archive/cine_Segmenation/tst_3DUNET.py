...
############################## 3DUNET #########################
subDirectory='08Oct_0718P_70I_10000E_1B'
...
# network
net = UNet3D(num_classes=4, in_channels=1, depth=4, start_filts=32, res=True).cpu()
net.load_state_dict(torch.load(os.path.join(PATH, "model-10000.pth.tar"))['state_dict'])
