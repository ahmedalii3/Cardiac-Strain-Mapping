...
class UpConv_block(tf.keras.Model):
    def __init__(self, num_filters):
        ...
        self.upconv = Conv2DTranspose(num_filters, 5, strides = 2, padding = 'same')
...
class Unet_1Dense_5Kernel(tf.keras.Model):
    def __init__(self):
        super(Unet_1Dense_5Kernel, self).__init__()
