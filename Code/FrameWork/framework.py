...
class Automate_Training():
    ...
    def load_data(self):
        ...
        if folders_in_train_simulator_directory[0] == "Displacement_loc":
            ...
            Displacement_directory = os.path.join(self.dataset_path, folders_in_train_simulator_directory[1])
            Frames_directory = os.path.join(self.dataset_path, folders_in_train_simulator_directory[0])
