...
class Automate_Training():
    ...
    def load_data(self):
        ...
        Displacement_directory = os.path.join(self.dataset_path, folders_in_train_simulator_directory[folders_in_train_simulator_directory.index("Displacement_loc")])
        Frames_directory = os.path.join(self.dataset_path, folders_in_train_simulator_directory[folders_in_train_simulator_directory.index("Frames_loc")])
        # Masks_directory = os.path.join(self.dataset_path, folders_in_train_simulator_directory[folders_in_train_simulator_directory.index("Masks_loc")])
        print(Displacement_directory)
    ...
    def train_models(self, num_epochs = 10, batch_size = 32):
        ...
        for model in self.models_list:
            ...
            model.compile(optimizer=optimizer, loss=Mask_loss, metrics=['mae'])
